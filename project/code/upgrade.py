...
class Upgrade:
    ...
    def create_items(self):
        ...
        for item, index in enumerate(range(self.attribute_number)):
            ...
            incremet = full_width // self.attribute_number
            left = (item * incremet) + (incremet - self.width)// 2
    ...
    def display(self):
        # self.display_surface.fill((255,215,0))
        self.input()
...
class Item:
    ...
    def trigger(self, player):
        ...
        if player.exp >= player.upgrade_cost[upgrade_attribute]:
            ...
            if player.stats[upgrade_attribute] * 1.2 <= player.max_stats[upgrade_attribute]:
